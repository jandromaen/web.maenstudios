 ...
 */
export const themeBootScript = `(function(){var e=document.documentElement;e.setAttribute("data-js","1");var t="${DEFAULT_THEME}";try{var s=localStorage.getItem("${THEME_STORAGE_KEY}");if(s==="dark"||s==="light")t=s}catch(x){}e.setAttribute("data-theme",t);e.setAttribute("data-anim","1")})();`;
