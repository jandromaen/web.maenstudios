...
export const posts: Post[] = [
  ...
  },
  {
    ...
    date: "2026-09-25",
    readingMinutes: 5,
    keywords: ["qué incluye el servicio de producción audiovisual", "servicio de producción audiovisual", "contratar producción audiovisual", "qué es la producción audiovisual", "presupuesto producción audiovisual"],
    excerpt: "«Producción audiovisual» significa cosas distintas según quién la venda. Esto es lo que suele incluir de verdad, y lo que conviene preguntar antes de firmar.",
    content: [
      { type: "p", text: "«Producción audiovisual» es una de esas frases que aparece en todas las propuestas y no dice gran cosa por sí sola. Puede cubrir una sesión de una hora con el móvil en trípode o un rodaje de dos días con equipo de iluminación, y el precio cambia en consecuencia. Si estás mirando presupuestos y quieres saber qué deberías estar recibiendo por lo que pagas, esto es lo que suele incluir el servicio, por fases, y qué preguntar antes de firmar." },
      { type: "h2", text: "Preproducción: lo que pasa antes de que llegue nadie con una cámara" },
      { type: "p", text: "La parte que menos se ve es la que más decide el resultado. Antes del rodaje hay que cerrar qué se va a grabar, en qué orden y con qué recursos, y eso no se improvisa el mismo día." },
      { type: "ul", items: [
        "Guion o escaleta: qué planos hacen falta y en qué orden, no una idea general de «algo de producto y algo de ambiente».",
        "Plan de rodaje con horarios: cuánto dura cada bloque, para no ocupar tu local más de lo necesario.",
        "Localización: si se rueda en tu espacio, en plató o hace falta permiso, se resuelve antes, no en la puerta.",
        "Referencias visuales: para que el criterio de cámara y de montaje esté acordado antes de grabar, no se discuta después.",
      ] },
      { type: "p", text: "Una propuesta que salta directa de «qué quieres grabar» a una fecha de rodaje se está saltando esta fase. Se nota después, cuando faltan planos o el rodaje se alarga porque nadie tenía claro qué tocaba hacer en cada momento." },
      { type: "h2", text: "El día de rodaje: quién viene y qué trae" },
      { type: "p", text: "Lo que necesitas del equipo que llega es poco, pero concreto: quién sostiene la cámara, quién dirige y quién decide si un plano vale o hay que repetirlo. En un rodaje pequeño puede ser la misma persona; en uno más grande, roles separados." },
      { type: "p", text: "El tiempo también es parte del servicio. Una jornada mal calculada acaba en dos horas de más o en planos que se sacrifican porque no queda tiempo. Antes de contratar, pregunta cuántas horas incluye el presupuesto y qué pasa si el rodaje se alarga: si es una franja abierta o si las horas extra se facturan aparte." },
      { type: "p", text: "Si el rodaje es en un negocio que sigue abierto —un restaurante, una tienda—, esto importa todavía más. Un equipo que entra con un plan claro y equipo ligero graba lo pactado y se va sin interrumpir el servicio; uno que llega a improvisar sobre la marcha ocupa el doble de tiempo y de espacio." },
      { type: "h2", text: "Postproducción: del material en bruto a la pieza que se publica" },
      { type: "p", text: "Rodar es la mitad del trabajo. Lo grabado en bruto no se puede publicar tal cual: hace falta seleccionar tomas, montar, corregir el color para que la luz sea consistente entre planos, meter subtítulos y, si el proyecto lo pide, motion graphics o grafismo. Esta fase suele llevar más horas que el propio rodaje, aunque sea la que menos se pregunta al pedir presupuesto." },
      { type: "p", text: "Aquí es donde más varía la calidad entre proveedores con el mismo precio de rodaje. Dos productoras pueden cobrar lo mismo por un día de grabación y entregar resultados muy distintos según cuántas horas de montaje incluya realmente el paquete." },
      { type: "p", text: "También es la fase donde se decide si el archivo final es tuyo de verdad. Pregunta en qué formato lo recibes, si incluye los proyectos de edición abiertos o solo el vídeo exportado, y cuánto tiempo se queda el material disponible después de la entrega." },
      { type: "h2", text: "Los formatos de entrega" },
      { type: "p", text: "El mismo rodaje casi nunca sirve para un único sitio. Un vídeo pensado para Instagram necesita formato vertical y un ritmo de corte más rápido; uno para la web o YouTube funciona mejor en horizontal y con planos más largos; una campaña de pago suele pedir versiones cortas de pocos segundos. Un servicio de producción completo entrega ya adaptado a cada uso, no un único archivo que luego hay que recortar por tu cuenta." },
      { type: "p", text: "Los subtítulos entran en el mismo paquete y no son un detalle menor: la mayoría de la gente ve vídeo en redes sin sonido, así que un vídeo sin subtítulos pierde a buena parte de quien lo empieza a ver en los primeros segundos." },
      { type: "h2", text: "Lo que no suele estar incluido (y conviene preguntar)" },
      { type: "p", text: "Hay partidas que quedan fuera del presupuesto base con más frecuencia de la que parece, y es mejor saberlo antes de firmar que descubrirlo en la factura final." },
      { type: "ul", items: [
        "Talento: si aparecen actores o modelos que no son parte del equipo del cliente, suele facturarse aparte.",
        "Alquiler de localización: un plató o un espacio externo tiene coste propio, distinto del servicio de producción.",
        "Jornadas o planos adicionales fuera de lo pactado en el plan de rodaje.",
        "Número de revisiones incluidas en el montaje: sin límite pactado, cada ronda extra puede sumar.",
        "El material en bruto: si el archivo original es tuyo al terminar o se queda solo con la pieza montada.",
      ] },
      { type: "p", text: "Ninguna de estas partidas es mala señal por sí sola. Lo que sí lo es que no aparezcan mencionadas hasta que ya has aceptado el presupuesto." },
      { type: "h2", text: "Pieza suelta o servicio recurrente" },
      { type: "p", text: "La producción audiovisual se contrata de dos formas distintas y conviene no confundirlas. Como pieza suelta: un rodaje puntual para un vídeo corporativo, un evento o un lanzamiento, con entrega cerrada y fin del proyecto. Y como servicio recurrente: rodajes periódicos que alimentan un calendario de publicación continuo, donde cada jornada se planifica pensando en varias semanas de contenido y no en una única pieza." },
      { type: "p", text: "La diferencia no es solo de volumen. Un servicio recurrente permite repartir el coste de preproducción entre más piezas y mantener una línea visual constante entre rodajes, algo que una pieza suelta no puede ofrecer por definición." },
      { type: "p", text: "Si vas a comparar presupuestos, pide que cada uno detalle estas mismas fases: qué incluye la preproducción, cuántas horas de rodaje, cuántas de montaje y en qué formatos se entrega. Es la forma más rápida de saber si estás comparando dos servicios equivalentes o uno completo contra otro a medias." },
    ],
  },
];
